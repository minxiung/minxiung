# 
```
 gcc helloCTF.c -o hello -save-temps --verbose
...
COLLECT_GCC_OPTIONS='-o' 'hello' '-save-temps' '-v' '-mtune=generic' '-march=x86-64'
 /usr/lib/gcc/x86_64-linux-gnu/10/cc1 -E -quiet -v -imultiarch x86_64-linux-gnu helloCTF.c -mtune=generic -march=x86-64 -fpch-preprocess -fasynchronous-unwind-tables -o helloCTF.i
...
End of search list.
COLLECT_GCC_OPTIONS='-o' 'hello' '-save-temps' '-v' '-mtune=generic' '-march=x86-64'
 /usr/lib/gcc/x86_64-linux-gnu/10/cc1 -fpreprocessed helloCTF.i -quiet -dumpbase helloCTF.c -mtune=generic -march=x86-64 -auxbase helloCTF -version -fasynchronous-unwind-tables -o helloCTF.s
...
COLLECT_GCC_OPTIONS='-o' 'hello' '-save-temps' '-v' '-mtune=generic' '-march=x86-64'
 as -v --64 -o helloCTF.o helloCTF.s
